  ...
  return (
    <Tabs defaultValue="overview" className="w-full">
      <TabsList className="overflow-x-auto flex w-full bg-[#F5F2D8] border-b border-[#141414]/10 mb-2">
        <TabsTrigger
          value="overview"
          className="min-h-[44px] flex items-center gap-2 text-[#141414]/50 hover:text-[#141414]/80 hover:bg-[#141414]/[0.05] data-[state=active]:text-[#141414] data-[state=active]:border-b-[3px] data-[state=active]:border-[#CAFF43] data-[state=active]:font-extrabold data-[state=active]:bg-[#CAFF43]/[0.07] rounded-t-lg"
        >
