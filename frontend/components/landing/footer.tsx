      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-[15px] leading-relaxed text-[#F5F2D8]/50 max-w-sm mb-6">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/cv-analyzer" className="text-[#F5F2D8]/70 hover:text-[#CAFF43] transition-colors text-sm font-medium">
                  CV Analyzer
                </Link>
              </li>
              <li>
                <span className="text-[#F5F2D8]/40 hover:text-[#F5F2D8]/70 cursor-not-allowed transition-colors text-sm font-medium flex items-center gap-2">
                  CV Builder
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-white/5 text-white/40">Soon</span>
                </span>
              </li>
              <li>
                <span className="text-[#F5F2D8]/40 hover:text-[#F5F2D8]/70 cursor-not-allowed transition-colors text-sm font-medium flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-[#F5F2D8]/70 hover:text-white transition-colors text-sm font-medium">
                  Privacy Policy
                </a>
              </li>
              <li>
