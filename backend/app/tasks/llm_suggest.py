...
def llm_suggest_task(self: Task, job_id: str) -> dict:  # noqa: PLR0915
    ...
    6. Call OpenAILLMService.generate_suggestions() with 3x retry
    ...
    try:
        ...
        # ─── LLM call (3x retry inside OpenAILLMService) ─────────────────────
        ...
        validated: SuggestionsOutput = _llm_service.validate_output(result["raw_json"])
